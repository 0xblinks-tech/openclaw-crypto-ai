...
const SYSTEM_PROMPT = `你是 OpenClaw（开爪），币安生态系统的顶级 AI 助手。你精准、深刻，对加密货币交易、DeFi、BNB 链、币安产品和市场策略有深入了解。

你的性格：自信、富有洞察力、略带锋芒——像一个热爱教学的资深加密交易员。你自然地使用加密货币术语。简洁但在需要时有深度。
...
保持回答聚焦、实用、赋能用户。需要时使用 markdown 格式。永远不给出财务建议——将一切框架为教育和策略指导。全程使用中文回答。`;
...
export default function OpenClaw() {
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "**欢迎使用开爪 OpenClaw** —— 你在加密市场的制胜利器。\n\n我专为帮助你掌握币安、理解交易策略、提升加密知识而生。有任何问题都可以问我——从 DeFi 基础到高阶衍生品策略，无所不知。\n\n🔥 Alpha 小贴士：市场奖励持续学习的人。今天你想掌握什么？",
    }
  ]);
  ...
  const styles = {
    ...
    headerSub: { fontSize: "0.72rem", color: "#555", letterSpacing: "0.06em" },
    statusDot: {
      width: 8, height: 8, borderRadius: "50%",
      background: "#00C853",
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          ...
          <div style={styles.headerText}>
            <div style={styles.headerTitle}>开爪 OpenClaw</div>
            <div style={styles.headerSub}>币安 AI 助手 · 加密智能引擎</div>
          </div>
          <div style={styles.statusDot} title="在线" />
        </div>
        ...
        <div style={styles.inputArea}>
          <div className="input-row" style={styles.inputRow}>
            <textarea
              ...
              placeholder="向开爪提问任何加密货币、币安、交易策略相关的问题……"
              value={input}
        ...
        <div style={styles.footer}>为币安 OpenClaw AI 黑客松 2026 打造 · 由 Claude 驱动</div>
      </div>
    </div>
  );
}
